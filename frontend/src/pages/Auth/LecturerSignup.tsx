...
import { ArrowRight, GraduationCap, ArrowLeft, Search, Mail } from 'lucide-react';
  ...
  const handleContinueToDashboard = async () => {
    try {
      ...
      await signUp(
        ...
        undefined,  // no university units for simple signup
        formData.name
      );
      ...
      <div className="w-full max-w-6xl mx-auto relative">
        ...
        {step === 1 && (
          <div className="max-w-md mx-auto space-y-6 sm:space-y-8 animate-fadeIn">
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold">Welcome to Lecturer Registration</h2>
        ...
        {step === 2 && (
          <div className="max-w-md mx-auto space-y-6 sm:space-y-8 animate-fadeIn">
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold">Enter Your Email</h2>
              <p className="text-zinc-400 text-sm sm:text-base">Please use your professional email address.</p>
              {error && <p className="text-red-500">{error}</p>}
            </div>
            <input
              type="email"
        ...
        {step === 3 && (
          <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8 animate-fadeIn">
            ...
            <p className="text-zinc-400 text-center text-sm">Choose the university where you teach</p>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                ...
                <div className="text-zinc-300 mb-2">
                  <p className="font-medium mb-1">Teaching at:</p>
                  <p className="text-sm">{formData.universityName}</p>
                </div>
              </div>
              <p className="text-zinc-400 text-sm sm:text-base">You're all set to explore your lecturer dashboard!</p>
              {error && <p className="text-red-500">{error}</p>}
            </div>
            <button 
